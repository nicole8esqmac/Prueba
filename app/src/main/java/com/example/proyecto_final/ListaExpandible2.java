...
public class ListaExpandible2 extends BaseExpandableListAdapter {

    private Context context;
    private List<String> ListTitulo;
    private HashMap<String, Formula2> expandablelistDetalle;

    public ListaExpandible2(Context context, List<String> listTitulo, HashMap<String, Formula2> expandablelistDetalle) {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        Formula2 formula = (Formula2)getChild(i,i1);

        if (view == null){
            LayoutInflater LayoutInflater = (android.view.LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);

            view = LayoutInflater.inflate(R.layout.lista_item2, null);
        }
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        Formula2 formula =(Formula2) getChild(i,0);

        if (view == null){
            LayoutInflater LayoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);

            view = LayoutInflater.inflate(R.layout.lista_grupo2, null);
        }
